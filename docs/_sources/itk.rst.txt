...
Ако искате да се върнете :ref:`на предната страница<section>`.


Ако искате да видите какво ви е нужно обърнете на :ref:`следния линк<need>`.

Ако искате да посетите сайта на университета отидете на: https://www.tugab.bg/index.php?lang=bg.

Ако искате да посетите сайта на университета `отидете tuk <https://www.tugab.bg/index.php?lang=bg>`_.